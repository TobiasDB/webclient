...
class Collection(Generic[T]):
    ...
    if TYPE_CHECKING:
        ...
        def select(self, selector: str, *, index: int = ..., error: Any = ...) -> "Collection[Document]": ...
        def select_all(self, selector: str, *, limit: int | None = ..., offset: int = ...) -> "Collection[Document]": ...
        def text_content(self) -> "Collection[Field[str]]": ...
        def title(self) -> "Collection[Field[str]]": ...
        def wait_for(self, selector: str | None = ..., *, timeout: float | None = ...) -> "Collection[Document]": ...
