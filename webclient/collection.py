...
class Collection(Generic[T]):
    ...
    if TYPE_CHECKING:
        ...
        def html(self) -> "Collection[Field[str]]": ...
        def is_empty(self) -> "Collection[Field[bool]]": ...
        def is_ok(self) -> "Collection[Field[bool]]": ...
        def links(self) -> "Collection[Reference]": ...
        def markdown(self, *, main_content_only: bool = ...) -> "Collection[Field[str]]": ...
        def message(self) -> "Collection[Field[str]]": ...
        def ref(self) -> "Collection[Reference]": ...
        def regex(self, pattern: str, *, group: int | str = ..., flags: str = ...) -> "Collection[Field[str]]": ...
        def region(self) -> "Collection[Field[str]]": ...
        ...
        def skeleton(self, *, max_lines: int = ..., text_chars: int = ..., max_depth: int = ..., max_siblings: int = ..., legend: bool = ..., collapse: bool = ..., drop_chrome: bool = ..., annotate_origin: bool = ...) -> "Collection[Field[str]]": ...
        def text(self, *, main_content_only: bool = ...) -> "Collection[Field[str]]": ...
