...
class LazyDocument(Lazy["Document"]):
    ...
    def is_empty(self) -> "LazyField[bool]": ...
    def is_ok(self) -> "LazyField[bool]": ...
    def metadata(self) -> "LazyField[Metadata]": ...
    ...
    def structure(self) -> "LazyField[Structure]": ...
    def summary(self) -> "LazyField[dict[str, Any]]": ...
    def transport(self) -> "LazyField[Transport]": ...
...
class LazyCollection(Lazy["Collection[T]"], Generic[T]):
    ...
    def metadata(self) -> "LazyCollection[LazyField[Metadata]]": ...
    ...
    def select_all(self, selector: str, *, limit: int | None = ..., offset: int = ...) -> "LazyCollection[LazyDocument]": ...
    def structure(self) -> "LazyCollection[LazyField[Structure]]": ...
    def summary(self) -> "LazyCollection[LazyField[dict[str, Any]]]": ...
    text_content: "LazyCollection[LazyField[str]]"
    title: "LazyCollection[LazyField[str]]"
    def transport(self) -> "LazyCollection[LazyField[Transport]]": ...
