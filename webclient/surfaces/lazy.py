...
class LazyDocument(Lazy["Document"]):
    ...
    def skeleton(self, *, max_lines: int = ..., text_chars: int = ..., max_depth: int = ..., max_siblings: int = ..., legend: bool = ..., collapse: bool = ..., annotate_origin: bool = ...) -> "LazyField[str]": ...
...
class LazyCollection(Lazy["Collection[T]"], Generic[T]):
    ...
    def select_all(self, selector: str, *, limit: int | None = ..., offset: int = ...) -> "LazyCollection[LazyDocument]": ...
    def skeleton(self, *, max_lines: int = ..., text_chars: int = ..., max_depth: int = ..., max_siblings: int = ..., legend: bool = ..., collapse: bool = ..., annotate_origin: bool = ...) -> "LazyCollection[LazyField[str]]": ...
