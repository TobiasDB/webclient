...
class LazyReference(Lazy["Reference"]):
    ...
    def resolve(self, *, browser: "bool | Literal['never', 'auto', 'always', 'probe']" = ..., optional: bool = ..., error: Any = ..., keep_alive: 'bool | float' = ...) -> "LazyDocument": ...
...
class LazyWebClient:
    ...
    def fetch(self, url: Any, *, browser: "bool | Literal['never', 'auto', 'always', 'probe']" = ..., optional: bool = ..., error: Any = ..., keep_alive: 'bool | float' = ..., **kw: Any) -> "LazyDocument": ...
    def ref(self, url: Any, method: str = ..., **kw: Any) -> "LazyReference": ...
    def search(self, query: str, *, limit: int = ..., endpoint: str | None = ..., browser: Any = ..., optional: bool = ..., error: Any = ...) -> "Lazy[list[SearchResult]]": ...
    def summary(self, url: Any, *include: str, browser: "bool | Literal['never', 'auto', 'always', 'probe']" = ..., resolve: Any = ..., optional: bool = ..., error: Any = ..., exclude: Any = ..., **kw: Any) -> "Lazy[Summary]": ...
# fmt: on
# >>> end generated <<<
