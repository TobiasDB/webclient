...
class LazyReference(Lazy["Reference"]):
    ...
    def resolve(self, *, browser: "bool | Literal['never', 'auto', 'always']" = ..., optional: bool = ..., error: Any = ...) -> "LazyDocument": ...
...
class LazyWebClient:
    ...
    def fetch(self, url: Any, *, browser: "bool | Literal['never', 'auto', 'always']" = ..., optional: bool = ..., error: Any = ..., **kw: Any) -> "LazyDocument": ...
    def ref(self, url: Any, method: str = ..., **kw: Any) -> "LazyReference": ...
    def search(self, query: str, *, limit: int = ..., endpoint: str | None = ...) -> "Lazy[list[SearchResult]]": ...
    def sitemaps(self, url: Any, *, limit: int = ...) -> "LazyCollection[LazyReference]": ...
