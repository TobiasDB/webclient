...
class LazyReference(Lazy["Reference"]):
    ...
    def resolve(self, *, browser: "bool | Literal['never', 'auto', 'always']" = ..., optional: bool = ..., error: Any = ..., keep_alive: 'bool | float' = ...) -> "LazyDocument": ...
...
class LazyDocument(Lazy["Document"]):
    ...
    def blocked(self) -> "Lazy[Signal]": ...
    def body_injected(self) -> "Lazy[Signal]": ...
    def click(self, selector: str | None = ..., *, timeout: float | None = ..., optional: bool = ..., error: Any = ...) -> "LazyDocument": ...
    def client_shell(self) -> "Lazy[Signal]": ...
    ...
    def xhr_composed(self) -> "Lazy[Signal]": ...
...
class LazyWebClient:
    ...
    def fetch(self, url: Any, *, browser: "bool | Literal['never', 'auto', 'always']" = ..., optional: bool = ..., error: Any = ..., keep_alive: 'bool | float' = ..., **kw: Any) -> "LazyDocument": ...
