...
class LazyReference(Lazy["Reference"]):
    ...
    def resolve(self, *, browser: "bool | Literal['never', 'auto', 'always']" = ..., policy: 'dict[str, Any] | None' = ..., optional: bool = ..., error: Any = ..., keep_alive: 'bool | float' = ..., wait: 'WaitConfig | None' = ...) -> "LazyDocument": ...
...
class LazyDocument(Lazy["Document"]):
    ...
    def anti_bot_triggered(self) -> "Lazy[Flag]": ...
    def as_json(self) -> "LazyDocument": ...
    @overload
    def attr(self, name: Literal['href', 'src', 'action']) -> "LazyReference": ...  # type: ignore[overload-overlap]
    @overload
    def attr(self, name: str, pattern: str | None = ..., *, group: int | str | None = ..., optional: bool = ..., error: Any = ...) -> "LazyField[str]": ...
    def buttons(self) -> "Lazy[Flag]": ...
    def card(self) -> "Lazy[PageCard]": ...
    def click(self, selector: str | None = ..., *, timeout: float | None = ..., optional: bool = ..., error: Any = ...) -> "LazyDocument": ...
    def elements(self) -> "list[Element]": ...
    def evaluate(self, script: str, *, mutates: bool = ...) -> "LazyField[Any]": ...
    @overload
    def events_of(self, event_type: type[E]) -> "list[E]": ...
    @overload
    def events_of(self, event_type: str) -> "list[Event]": ...
    def flags(self) -> "list[Flag]": ...
    def forms(self) -> "Lazy[Flag]": ...
    def framework(self) -> "LazyField[str]": ...
    def html(self) -> "LazyField[str]": ...
    def iframe(self) -> "Lazy[Flag]": ...
    def is_empty(self) -> "LazyField[bool]": ...
    def is_ok(self) -> "LazyField[bool]": ...
    def large_document(self) -> "Lazy[Flag]": ...
    def links(self) -> "LazyCollection[LazyReference]": ...
    def login_present(self) -> "Lazy[Flag]": ...
    def login_required(self) -> "Lazy[Flag]": ...
    def markdown(self, *, main_content_only: bool = ...) -> "LazyField[str]": ...
    def metadata(self) -> "Lazy[Metadata]": ...
    def pagination(self) -> "Lazy[Flag]": ...
    def ref(self) -> "LazyReference": ...
    def regex(self, pattern: str, *, group: int | str = ..., flags: str = ...) -> "LazyField[str]": ...
    ...
    def shadow_dom(self) -> "Lazy[Flag]": ...
    def skeleton(self, *, max_lines: int = ..., text_chars: int = ..., max_depth: int = ..., max_siblings: int = ..., legend: bool = ..., collapse: bool = ..., drop_chrome: bool = ..., annotate_origin: bool = ..., correlate: bool = ..., mark_records: bool = ..., mark_interactive: bool = ...) -> "LazyField[str]": ...
    def spa(self) -> "Lazy[Flag]": ...
    def structure(self) -> "Lazy[Structure]": ...
    def tabbed(self) -> "Lazy[Flag]": ...
...
class LazyCollection(Lazy["Collection[T]"], Generic[T]):
    def as_json(self) -> "LazyCollection[LazyDocument]": ...
    def attr(self, name: str, pattern: str | None = ..., *, group: int | str | None = ..., optional: bool = ..., error: Any = ...) -> "LazyCollection[LazyField[str]]": ...
    def click(self, selector: str | None = ..., *, timeout: float | None = ..., optional: bool = ..., error: Any = ...) -> "LazyCollection[LazyDocument]": ...
    def evaluate(self, script: str, *, mutates: bool = ...) -> "LazyCollection[LazyField[Any]]": ...
    def framework(self) -> "LazyCollection[LazyField[str]]": ...
    ...
    def regex(self, pattern: str, *, group: int | str = ..., flags: str = ...) -> "LazyCollection[LazyField[str]]": ...
    region: "LazyCollection[LazyField[str]]"
    ...
    def select_all(self, selector: str, *, limit: int | None = ..., offset: int = ...) -> "LazyCollection[LazyDocument]": ...
    def skeleton(self, *, max_lines: int = ..., text_chars: int = ..., max_depth: int = ..., max_siblings: int = ..., legend: bool = ..., collapse: bool = ..., drop_chrome: bool = ..., annotate_origin: bool = ..., correlate: bool = ..., mark_records: bool = ..., mark_interactive: bool = ...) -> "LazyCollection[LazyField[str]]": ...
