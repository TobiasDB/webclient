...
class LazyDocument(Lazy["Document"]):
    ...
    def wait_for(self, selector: str | None = ..., *, timeout: float | None = ..., optional: bool = ...) -> "LazyDocument": ...
...
class LazyCollection(Lazy["Collection[T]"], Generic[T]):
    ...
    def wait_for(self, selector: str | None = ..., *, timeout: float | None = ..., optional: bool = ...) -> "LazyCollection[LazyDocument]": ...
...
class LazyWebClient:
    ...
    def search(self, query: str, *, limit: int = ..., endpoint: str | None = ..., optional: bool = ...) -> "Lazy[list[SearchResult]]": ...
