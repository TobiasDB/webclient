...
class WebBase(BaseModel):
    ...
    # The ops (extract/project/field/reference(s)/document(s)/is_ok/is_empty)
    # live in ``core.ops`` (PLAN §9); these stay as the internal plumbing the
    # ops call. Typed eager signatures are generated into the block below.
